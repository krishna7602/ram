...
4. Configure as follows:
   - **Name**: `ram`
   - **Type**: `sse`
   - **URL**: `https://ram-heg2lzpui-r-krishna-mondals-projects.vercel.app/sse`
...
3. Input the SSE URL: `https://ram-heg2lzpui-r-krishna-mondals-projects.vercel.app/sse`
